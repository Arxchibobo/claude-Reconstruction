...
from veo3_api import Veo3VideoGenerator
...
class VideoMaterialsGenerator:
    ...
    def __init__(
        self,
        veo3_client: Optional[Veo3VideoGenerator] = None,
    ...
    def generate_preview_video(
        ...
        try:
            self.veo3_client.generate_and_download(
